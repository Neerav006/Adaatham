...
import com.adaatham.suthar.view.AddMatrimonialActivity;
...
import com.adaatham.suthar.view.YourMemberActivity;
...
public class AgentDashBoardFragment extends Fragment implements OnImagePressedListener {
    ...
    private CardView cvAddMatrimonial;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        cvYourMember = (CardView) view.findViewById(R.id.cvYourMember);
        cvMyFamily = view.findViewById(R.id.cvMyFamily);
        cvAddBusiness = view.findViewById(R.id.cvAddBusinessDirectory);
        cvAddMatrimonial = view.findViewById(R.id.cvAddMatrimony);
        ...
        cvYourMember.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), YourMemberActivity.class);
                startActivity(intent);
            }
        });
...
//
        ...
        cvAddMatrimonial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), AddMatrimonialActivity.class);
                startActivity(intent);
